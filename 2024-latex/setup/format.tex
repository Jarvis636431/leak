...
\titlecontents{chapter}[2em]{\vspace{.25\baselineskip}\defaultfont\song}
             {\hei\thecontentslabel\hspace{14pt}\song}{}
             {\titlerule*[5pt]{$\cdot$}\contentspage}
\titlecontents{section}[4em]{\vspace{.25\baselineskip}\defaultfont\song}
             {\hei\thecontentslabel\hspace{19pt}\song}{}
             {\titlerule*[5pt]{$\cdot$}\contentspage}
\titlecontents{subsection}[6em]{\vspace{.25\baselineskip}\defaultfont\song}
             {\hei\thecontentslabel\hspace{19pt}\song}{}
             {\titlerule*[5pt]{$\cdot$}\contentspage}
...
\newcommand{\@coverfield}[2]{%
  \noindent\hspace*{3.05cm}{\song\sanhao\bfseries
  #1\quad\underline{\makebox[6.2cm][c]{#2}}}\par\vspace{4pt}%
}
...
\def\makecover{
    ...
    \includepdf[pages=1,pagecommand={\thispagestyle{empty}}]{../【2025修订版】1-1天津大学本科生毕业论文模板.pdf}
}

%%%%%%%%%%%%%%%%%%%    Abstract    %%%%%%%%%%%%%%%%%%%%%%%
\def\makeabstract{
	\titleformat{\chapter}{\centering\erhao\song\bfseries}{\chaptername}{2em}{} %"摘要"二号宋体加粗居中
...
%%%%% Chinese Abstract %%%%%
	...
	{\song\sihao\bfseries 关键词：} \@ckeywords
	% \thispagestyle{empty}

%%%%% English Abstract %%%%%
	\titleformat{\chapter}{\centering\erhao\rmfamily\bfseries}{\chaptername}{2em}{} %"ABSTRACT"二号Times New Roman加粗居中
	\clearpage
	...
	\hangafter=1\hangindent=0pt\noindent
	{\rmfamily\sihao\bfseries KEY WORDS:} \@ekeywords
	% \thispagestyle{empty}
}
